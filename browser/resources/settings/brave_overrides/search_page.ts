...
RegisterPolymerTemplateModifications({
  'settings-search-page': (templateContent) => {
    ...
    const searchEngineTitleElement =
      templateContent.querySelector('div.default-search-engine')
    if (searchEngineTitleElement &&
        searchEngineTitleElement.firstChild &&
        searchEngineTitleElement.firstChild.nodeType === Node.TEXT_NODE) {
